...
public class PartiePanelReseau extends JPanel {
	...
	private Pos posCoup = null;
	
	//Constructeurs
	public PartiePanelReseau(Joueur joueur) {
		this.joueur = joueur;
		this.nbrBat = joueur.getCarteAffichee().getNbrBat();
		
		initPanel();
	}
	public PartiePanelReseau(Joueur joueur, JPanel panAnimation) {
		this.joueur = joueur;
		this.nbrBat = joueur.getCarteAffichee().getNbrBat();
